    ...
    <div className={style.ThirdStep}>
      ...
      <div className={style.ReposContainer}>
        <div className={style.RepoCard}>
          ...
          <div>
            <p>
              Listo para despliegue ❤ Plantilla de código base para desarrollar
              una PWA con React & Next, incluye +10 Hooks, Light/Dark Theme, y
              Componentes útiles para maquetar a la velocidad de la luz ⚡
              (también incluye navegación para desarrollo).
            </p>
          </div>
        </div>
        <div className={style.RepoCard}>
